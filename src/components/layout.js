            ...
            <div className="sidebar">
              ...
              <ul className="sidebar__menu">
                <li>
                  <Location>
                    {({ location }) => { 
                      return <Link className={location.pathname.includes('/work')?"on":""} to="/">Projects</Link>
                    }}
                  </Location>
                </li>
                <li>
                  <Link to="/maow">Maow Book</Link>
                </li>
                <li>
                  <Link to="/art">Art &amp; craft</Link>
                </li>
                <li>
              ...
              <div className="sidebar__footer">
                <p>
                  ...
                  <a href="mailto:hello@anna-touvron.com" target="_blank" rel="noopener noreferrer">hello@anna-touvron.com</a><br/> 
